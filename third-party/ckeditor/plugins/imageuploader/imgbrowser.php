...
//        else { echo "<p class=\"folderInfo\">In total: $count Files</p>"; };
        ...
        echo '<div id="folderError">The folder <b>'.$useruploadfolder.'</b> could not be found. Please choose another folder in the settings.</div>';
    }
...
<div id="uploadImgDiv">
    <form action="imgupload.php" method="post" enctype="multipart/form-data">
        <div class="buttonBar">
            ...
            <button type="submit" class="headerBtn greenBtn" name="submit"><img src="img/cd-icon-upload.png" class="headerIcon"> Upload</button>
        </div><br><br><br>
