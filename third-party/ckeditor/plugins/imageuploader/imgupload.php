...
// For licensing, see LICENSE.md
	...
	if ($uploadOk == 0) {
		echo "Sorry, your file was not uploaded. Don't forget to set CHMOD writable permission (0777) to imageuploader folder on your server.";
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($_FILES["upload"]["tmp_name"], $target_file)) {
			...
			echo "Sorry, there was an error uploading your file - ".$target_file." - Don't forget to set CHMOD writable permission (0777) to imageuploader folder on your server.";
			exit;
		}
	}
